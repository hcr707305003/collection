...
function ckcpt() {
	...
	if(PlayM3u8.definition){
		cpt += 'definition.swf,2,2,-240,-30,2,1|';
	}
	if(PlayM3u8.qrcode){
		cpt += 'qrcode.swf,2,2,-440,-26,2,1|';
	}
    if(PlayM3u8.prompttext){
		cpt += 'prompttext.swf,1,2,0,-100,2,0|';
	}
	if(PlayM3u8.downspeeds){
		cpt += 'downloadspeeds.swf,2,2,-385,-26,2|';
	}
	return cpt
}
function ckstyle() {
	var ck = {
		...
		mylogo: "logo.swf",
		pm_mylogo: '1,1,-455,-340',
		logo: PlayM3u8.playm3u8_logo,
		pm_logo: PlayM3u8.pm_logo,
		...
		cpt_definition:'0xffff00,0xcccc33,80,20,0x000000,0xffffff,10,10,1,3,自动,12,MicrosoftYaHei|微软雅黑,0x000000,10,80,20,15,0,10,15,0xffff00,0xcccc33,60,20,0x000000,0xffffff,10,10,1,3,12,MicrosoftYaHei|微软雅黑,40,0xb7b7b7,30,1,10,10',
		cpt_list: ckcpt()
	};
	return ck
}(function() {
